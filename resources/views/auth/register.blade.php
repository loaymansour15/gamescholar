            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="user-type" class="col-md-4 col-form-label text-md-right">{{ __('Role') }}</label>

                            <div class="input-group col-md-6">
                                <div class="input-group-append">
                                    <label class="input-group-text" for="user-type">Choose</label>
                                  </div>
                                  <select class="custom-select" id="user-type" name="role">
